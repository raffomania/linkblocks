...
pub async fn app(state: AppState) -> anyhow::Result<Router> {
    ...
    Ok(Router::new()
        ...
        // TODO fix this layer, using the same URL for AP and HTML
        // should simplify things and be more error tolerant for other
        // services
        .layer(FederationMiddleware::new(state.federation_config))
